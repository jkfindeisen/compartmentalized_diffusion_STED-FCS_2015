...
% Example of free diffusion FCS simulation
%
...
initialize();
fprintf('Run a free diffusion example.\n');

% producing some data
runSimulation('free.example.mat');
...
for ki = 1 : repetitions
    ...
    % each time (ki = 1, 2, 3, ..)
    [~, Di, TauD] = free_simulation_run(Tp, Np, Dp, dt, SR, fwhms, ki);
